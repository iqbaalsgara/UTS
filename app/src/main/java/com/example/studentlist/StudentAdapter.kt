        ...
        fun onBind(student: Student){
            ...
            itemView.setOnLongClickListener{
                ...
                alertDialogBuilder.setTitle("Konfirmasi")
                    .setMessage("Apakah kamu yakin ingin menghapus data "+student.name+"?")
                    .setCancelable(true)
                    .setPositiveButton("Tidak"){dialog,which->
                        Toast.makeText(itemView.context, "Hapus Dibatalkan", Toast.LENGTH_SHORT).show()
                    }
                    .setNegativeButton("Iya"){dialog,which->
                        ...
                        Toast.makeText(itemView.context,"Hapus Sukses",Toast.LENGTH_SHORT).show()
                    }
